        ...
        <div class="col-md-3 menu">
            <div class="d-flex flex-column flex-shrink-0 p-3 menu-dashboar" style="width: 100%; min-height: 100vh">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item">
                        <a href="/dashboard/1/" class="nav-link link-dark" aria-current="page">
                        <i class="fa-solid fa-house me-2"></i>
                        Inicio
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/1/category" class="nav-link link-dark">
                        <i class="fa-solid fa-sitemap me-2"></i>
                        Categorias
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/1/products" class="nav-link link-dark">
                        <i class="fa-solid fa-boxes-stacked me-2"></i>
                        Produtos
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/1/pendingOrders" class="nav-link link-dark">
                        <i class="fa-solid fa-clipboard-question me-2"></i>
                        Pedidos pendentes
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/1/paidOrders" class="nav-link link-dark">
                        <i class="fa-solid fa-clipboard-list me-2"></i>
                        Pedidos pagos
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/1/completedOrders" class="nav-link link-dark">
                        <i class="fa-solid fa-clipboard-check me-2"></i>
                        Pedidos concluidos
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/1/clients" class="nav-link link-dark">
                        <i class="fa-solid fa-users me-2"></i>
                        Clientes
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/1/users" class="nav-link link-dark">
                ...
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="../../assets/img/perfil_standart.jpg" alt="" width="32" height="32" class="rounded-circle me-2">
                        <strong>Admin</strong>
                    </a>
                    <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
                        ...
                        <li>
                            <form action="../controllers/singout.php?id=" method="post">
